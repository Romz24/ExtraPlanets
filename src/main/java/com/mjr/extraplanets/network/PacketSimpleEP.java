					...
					case 0:
						if (playerBaseClient.ridingEntity instanceof EntityVehicleBase) {
							...
							MCUtilities.getClient()
									.displayGuiScreen(new GuiPoweredVehicleBase(playerBaseClient.inventory, (EntityPoweredVehicleBase) playerBaseClient.ridingEntity, ((EntityPoweredVehicleBase) playerBaseClient.ridingEntity).getType()));
							playerBaseClient.openContainer.windowId = (Integer) this.data.get(0);
						}
						break;
				}
