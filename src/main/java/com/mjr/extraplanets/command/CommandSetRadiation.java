	...
	public void processCommand(ICommandSender sender, String[] args) throws CommandException {
		...
		if (args.length == 2) {
			...
			try {
				...
				playerBase.addChatMessage(new ChatComponentText(EnumColor.AQUA + "Updated Radiation Level for: " + playerToAddFor.getName() + " to " + args[1] + "/100"));
				playerToAddFor.addChatMessage(new ChatComponentText(EnumColor.AQUA + playerBase.getName() + " has updated your Radiation Level to " + args[1] + "/100"));
